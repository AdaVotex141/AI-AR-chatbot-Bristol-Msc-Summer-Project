<template>
    <div>
      <!-- Modal toggle -->
      <el-button class="addButton" type="primary" @click="toggleModal" >
        <!-- plus icon -->
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
              <!-- User input -->
              <p class="text-gray-500 dark:text-gray-400 mb-4">Input your customized routine:</p>
              <div class="user-input">
                <el-input v-model="dayroutineStore.newTodo" placeholder="Add a new routine!" clearable />
              </div>
                ...
                <li v-for="(period, index) in periods" :key="period.value">
                  ...
                  <label :for="period.value" class="inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-500 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:bg-gray-600 dark:hover:bg-gray-500">
                    <div class="block">
                      ...
                      <!-- <div class="w-full text-gray-500 dark:text-gray-400">{{ period.describe }}</div> -->
                    </div>
...
let periods = reactive([
    { value: 'daily', title: 'Daily routine', describe: 'aaa' },
    { value: 'weekly', title: 'Weekly routine', describe: 'bbb' },
    { value: 'monthly', title: 'Monthly routine', describe: 'ccc' },
])
